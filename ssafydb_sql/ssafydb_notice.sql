...
CREATE TABLE `notice` (
  ...
  `id` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  ...
  `viewcnt` int(200) DEFAULT '0',
  PRIMARY KEY (`no`),
  KEY `fk_notice_id_idx` (`id`),
...
INSERT INTO `notice` VALUES (1,'admin','첫번째 공지사항입니다.','공지사항입니다.ㅎㅎ',5),(2,'admin','두번째 공지사항입니다.','공지사항 ㅎㅎㅎ',0);
