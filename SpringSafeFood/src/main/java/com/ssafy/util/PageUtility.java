...
//        System.out.println("nexttenpage:"+nexttenpage);
        ...
        if(firstpagecount>pagePercount)
            sb.append(" <a href='javascript:pagelist("+beforetenpage+")'><img src=\""+imagepath+"btn_first.gif\" border='0'  hspace='3' onclick='javascript:pagelist(1)' align='absmiddle'></a>&nbsp;&nbsp;");
        else
            sb.append("<img src=\""+imagepath+"btn_first.gif\" border='0' onclick='javascript:pagelist(1)' align=absmiddle>&nbsp;&nbsp;");

        if(((currentpagecount-1)/pagePercount*pagePercount)+1>beforetenpage)
            sb.append("<a href='javascript:pagelist("+ beforetenpage+")'><img src=\""+imagepath+"btn_prev.gif\" border='0' hspace='3' onclick='javascript:pagelist("+ (currentpagecount-1<1?1:currentpagecount-1)+")' align=absmiddle></a>&nbsp;&nbsp;");
        else
            sb.append("<img src=\""+imagepath+"btn_prev.gif\" border='0' onclick = 'javascript:pagelist("+ (currentpagecount-1<1?1:currentpagecount-1)+")'  align=absmiddle>&nbsp;&nbsp;");
        ...
        if(nexttenpage<((totalpagecount-1)/pagePercount+1)*pagePercount)
            sb.append("&nbsp;&nbsp;<a href='javascript:pagelist("+ (nexttenpage)+ ")'><img src=\""+imagepath+"btn_next.gif\" border='0' hspace='3' onclick='javascript:pagelist("+ (currentpagecount+1>totalpagecount?totalpagecount:currentpagecount+1)+ ")' align=absmiddle></a>");
        else
            sb.append("&nbsp;&nbsp;<img src=\""+imagepath+"btn_next.gif\" border='0' hspace='3' onclick='javascript:pagelist("+ (currentpagecount+1>totalpagecount?totalpagecount:currentpagecount+1)+ ")' align=absmiddle>");

        if((((currentpagecount-1)/pagePercount)+1)*pagePercount < nexttenpage)
            sb.append("&nbsp;&nbsp;<a href='javascript:pagelist("+ (nexttenpage)+")'><img src=\""+imagepath+"btn_end.gif\" border='0' onclick='javascript:pagelist("+totalpagecount+")' align=absmiddle></a>");
        else
            sb.append("&nbsp;&nbsp;<img src=\""+imagepath+"btn_end.gif\" onclick='javascript:pagelist("+totalpagecount+")' border='0' align=absmiddle>");
        return sb.toString();
    }
