	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 mx-auto">
				...
				<form id="frm" method="post" action="modify.do" enctype="multipart/form-data">
					...
					<table id="foodTb">
						...
						<tr>
							<td rowspan="5" >
								...
								<input type="file" class="form-control mr-sm-2"  name="fileup" id="add_img"/>
							</td>
							<td style="width: 125px;">
							<h5>제품명</h5>
							</td>
							<td style="width: 60%;"><input type="text" name="name" value="${food.name}"/></td>
						</tr>
						<tr >
							<td><h5>제조사</h5></td>
							<td><input type="text" name="maker" value="${food.maker}"/></td>
						</tr>
						<tr>
							<td><h5>원재료</h5></td>
							<td><textarea style="width: 100%"  name="material" rows="10" cols="20">${food.material}</textarea></td>
						</tr>
						<tr>
							<td colspan="5">
							<!-- Mydiet, 추가버튼 -->
							<input type="submit" class="fas fa-times btn btn-primary" value="수정" >
							<input type="button" class="fas fa-times btn btn-primary" onclick="window.history.back();" value="취소"></input>
							</td>
						</tr>
					</table>
					</form>
